...
<section class="blue lighten-4">
    <h3 class="light grey-text text-darken-3 center">Category</h3>
</section>
    ...
    @include('includes.messages')
        <div class="row">
            <div class="input-field col m6 s12 push-m2">
                ...
                <input id="name" type="text" value="{{$category->name}}" name="name" class="validate">
        ...
        <div class="row">
            <div class="input-field col m6 s12 push-m2">
                <i class="material-icons prefix">colorize</i>
                <input id="slug" name="slug" type="text" value="{{$category->slug}}" class="validate">
